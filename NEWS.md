...
- Expose additional `ComplexHeatmap` arguments in heatmap functions: `border_color` in `plot_expr_heatmap()`, and `show_row_names`, `show_column_names`, `names_font_size` in `plot_corr_heatmap()`. (#211, @copilot)
