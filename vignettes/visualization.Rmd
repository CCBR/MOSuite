...
The plotting functions called by the main analysis functions can be called directly
so you can customize plots to fit your needs.
...
You can customizing them by adding more ggplot layers, just like any other ggplot.
...
default colors are automatically picked from `mosuite_palette` and set in the analyses slot. You can see the defaults like so:
