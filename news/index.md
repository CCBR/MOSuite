...
- Fix S7 dispatch argument mismatch in
  ...
  [@kelly-sovacool](https://github.com/kelly-sovacool))
- Fix crash in
  [`remove_low_count_genes()`](https://ccbr.github.io/MOSuite/reference/remove_low_count_genes.md)
...
- A docker container with only MOSuite’s dependencies, not MOSuite
  ...
  [@kelly-sovacool](https://github.com/kelly-sovacool))
- Minor bug fixes in
  [`calc_cpm_df()`](https://ccbr.github.io/MOSuite/reference/calc_cpm_df.md),
...
- New utility functions to reduce code duplication across Code Ocean
  ...
  [@kelly-sovacool](https://github.com/kelly-sovacool))
  [`setup_capsule_environment()`](https://ccbr.github.io/MOSuite/reference/setup_capsule_environment.md),
  [`load_moo_from_data_dir()`](https://ccbr.github.io/MOSuite/reference/load_moo_from_data_dir.md),
  [`parse_optional_vector()`](https://ccbr.github.io/MOSuite/reference/parse_optional_vector.md),
  [`parse_vector_with_default()`](https://ccbr.github.io/MOSuite/reference/parse_vector_with_default.md),
  and
  [`parse_samples_to_rename()`](https://ccbr.github.io/MOSuite/reference/parse_samples_to_rename.md).
