...
You can create the plots generated by the main analysis functions
directly so you can customize them to fit your needs.
...
Plot the read depth of the clean counts, using either the `Group` column
or the `Batch` column from the metadata for the fill colors:
...
customize them by adding more ggplot layers, just like any other ggplot.
...
in the analyses slot. You can access the defaults directly:
...
View the colors in a multiOmicDataSet with
...
![](visualization_files/figure-html/display_colors-1.png)
...
![](visualization_files/figure-html/plots_custom_palette-1.png)
...
![](visualization_files/figure-html/plots_custom_palette-2.png)
...
![](visualization_files/figure-html/plots_custom_palette-3.png)
