...
multiOmicsSuite (`MOSuite`) is an R package for differential multi-omic
analysis. It defines an S7 class called `multiOmicDataSet` to store data
and analyses from multi-omic experiments.
