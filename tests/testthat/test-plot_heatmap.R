...
test_that("plot_expr_heatmap uses selected gene distance metric", {
  counts_dat <- data.frame(
    ...
    s5 = c(
      ...
      -0.39428995, -0.05931340, 1.10002537, 0.76317575
    ),
    check.names = FALSE
  )
...
test_that("plot_expr_heatmap uses selected sample clustering method", {
  counts_dat <- data.frame(
    Gene = paste0("g", 1:8),
    s1 = c(
      -0.89691455, 0.18484918, 1.58784533, -1.13037567,
      -0.08025176, 0.13242028, 0.70795473, -0.23969802
    ),
    s2 = c(
      1.9844739, -0.1387870, 0.4176508, 0.9817528,
      -0.3926954, -1.0396690, 1.7822290, -2.3110691
    ),
    s3 = c(
      0.87860458, 0.03580672, 1.01282869, 0.43226515,
      2.09081921, -1.19992582, 1.58963820, 1.95465164
    ),
    s4 = c(
      0.004937777, -2.451706388, 0.477237303, -0.596558169,
      0.792203270, 0.289636710, 0.738938604, 0.318960401
    ),
    s5 = c(
      1.0761644, -0.2841577, -0.7766753, -0.5956605,
      -1.7259798, -0.9025845, -0.5590619, -0.2465126
    ),
    s6 = c(
      -0.38358623, -1.95910318, -0.84170506, 1.90354747,
      0.62249393, 1.99092044, -0.30548372, -0.09084424
    ),
    check.names = FALSE
  )
  sample_metadata <- data.frame(
