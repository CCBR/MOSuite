...
test_that("diff_counts works for RENEE", {
  ...
  expected <- tibble(gene_id = c(
    ...
    9.45730344083432, 9.45730344083432,
    8.66549799171372, 9.45730344083432, 8.66549799171372, 8.66549799171372
  ), KO_S4 = c(
    12.5038393514913, 8.55117162604418, 9.34297707516479,
    8.55117162604418, 9.34297707516479, 8.55117162604418
  ), WT_S1 = c(
    12.408280593266,
    8.87780357784013, 8.87780357784013, 8.87780357784013, 8.87780357784013,
    14.6356071058433
  ), WT_S2 = c(
