  ...
  expect_equal(
    ...
    structure(
      list(
        ...
        FC = c(
          -42.7465863415622,
          3.85002020608143, -7.71439441748029,
          -7.03849783123801, -5.29181569343323,
          8.87382341151917
        ),
        logFC = c(
          -5.41773730869316,
          1.94486601753143, -2.94755290920186, -2.81526755916543, -2.40376281543362,
          3.14955584391085
        ),
        tstat = c(
          -15.6879749543426,
          12.9102607749226,
          -11.3808403447749, -11.0312744854072, -10.6584674633331,
          10.5614738819538
        ),
        pval = c(
    ...
    structure(
      list(
        ...
        FC = c(
          -17.6925615963148,
          2.57712293045075,
          -10.2589472087027, -3.22520189762021,
          4.43444692871868,
          -2.36807519790042
        ),
        logFC = c(
          ...
          -3.35881078151314,
          -1.68938947606405,
          2.1487541805238, -1.24371489427577
        ),
        tstat = c(
          -2.19458425130448,
          2.1944817392618, -2.19287280238278,
          -2.19094226223025,
          2.19079653013039,
          -2.18921321212647
        ),
