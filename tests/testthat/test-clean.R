...
test_that("check_sample_names works for dataframes & tibbles", {
  expect_true(check_sample_names(nidap_raw_counts, nidap_sample_metadata, sample_id_colname = "Sample"))
  expect_true(check_sample_names(as.data.frame(nidap_raw_counts), as.data.frame(nidap_sample_metadata), sample_id_colname = "Sample"))
  expect_error(
