...
#' @name plot_pca_3d
#' @export
plot_pca_3d <- S7::new_generic("plot_pca_3d", "moo_counts", function(moo_counts,
                                                                     count_type = NULL,
                                                                     sub_count_type = NULL,
...
#' @name plot_pca_3d
#' @export
S7::method(plot_pca_3d, multiOmicDataSet) <- function(moo_counts,
                                                      count_type = NULL,
                                                      sub_count_type = NULL,
                                                      sample_metadata = NULL,
                                                      feature_id_colname = NULL,
...
#' @rdname plot_pca_3d
#' @name plot_pca_3d
S7::method(plot_pca_3d, S7::class_data.frame) <- function(moo_counts,
                                                          count_type = NULL,
                                                          sub_count_type = NULL,
                                                          sample_metadata = NULL,
                                                          feature_id_colname = NULL,
